 ...
 * </p>
 */
public class MessageLinkDialog extends IconAndMessageDialog {
	 ...
	 * 
	 * @see #MessageDialog(Shell, String, Image, String, int, String[], int)
	 * @see #open(int, Shell, String, String, int, Runnable)
	 */
	...
	private IMessageLinkDialogListener linkDialogListener;
	...
	public MessageLinkDialog(Shell parentShell, String dialogTitle, Image dialogTitleImage, String dialogMessage,
			...
			IMessageLinkDialogListener linkDialogListener) {
		super(parentShell);
	...
	public static boolean open(int kind, Shell parent, String title, String message, int style,
			IMessageLinkDialogListener linkDialogListener) {
		MessageLinkDialog dialog = new MessageLinkDialog(parent, title, null, message, kind, getButtonLabels(kind), 0,
				linkDialogListener);
		style &= SWT.SHEET;
	...
	public static boolean openConfirm(Shell parent, String title, String message,
			IMessageLinkDialogListener linkDialogListener) {
		return open(CONFIRM, parent, title, message, SWT.NONE, linkDialogListener);
	}
	...
	public static void openError(Shell parent, String title, String message,
			IMessageLinkDialogListener linkDialogListener) {
		open(ERROR, parent, title, message, SWT.NONE, linkDialogListener);
	}
	...
	public static void openInformation(Shell parent, String title, String message,
			IMessageLinkDialogListener linkDialogListener) {
		open(INFORMATION, parent, title, message, SWT.NONE, linkDialogListener);
	}
	...
	public static boolean openQuestion(Shell parent, String title, String message,
			IMessageLinkDialogListener linkDialogListener) {
		return open(QUESTION, parent, title, message, SWT.NONE, linkDialogListener);
	}
	...
	public static void openWarning(Shell parent, String title, String message,
			IMessageLinkDialogListener linkDialogListener) {
		open(WARNING, parent, title, message, SWT.NONE, linkDialogListener);
	}
	...
	public interface IMessageLinkDialogListener {
