...
public class CleanupChangesDialog {
	...
	private static class BranchesLabelProvider extends LabelProvider {
		...
		private static Image IMG_STABLE = GerritToolsPlugin.getDefault().getImage(GerritToolsPlugin.IMG_BRANCH);
		private static Image IMG_CHANGE = GerritToolsPlugin.getDefault().getImage(GerritToolsPlugin.IMG_GERRIT_CHANGE);
