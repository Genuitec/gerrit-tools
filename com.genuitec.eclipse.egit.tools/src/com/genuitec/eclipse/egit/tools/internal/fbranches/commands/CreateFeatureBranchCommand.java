...
import com.genuitec.eclipse.egit.tools.internal.fbranches.dialogs.CreateFeatureBranchDialog;
		...
		private void createBranchRemotely(IProgressMonitor monitor, 
			...
			for (URIish uri: result.getURIs()) {
				...
				if (msg != null && !msg.isEmpty()) {
					throw new CoreException(new Status(IStatus.ERROR, EGitToolsPlugin.PLUGIN_ID, msg));
				}
			}
